...
/**
 * @title GridToken (GRID)
 * @notice ERC-20 reward token for The Grid protocol on MegaETH.
 *         - 5,000,000 hard cap
 *         - Only authorized minter (TheGrid contract) can mint
...
contract GridToken is ERC20, Ownable {
    ...
    constructor() ERC20("The Grid", "GRID") Ownable(msg.sender) {}
